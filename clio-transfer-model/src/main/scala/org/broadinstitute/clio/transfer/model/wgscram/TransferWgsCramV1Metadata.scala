...
import org.broadinstitute.clio.transfer.model.{DeliverableMetadata, TransferMetadata}
...
case class TransferWgsCramV1Metadata(
  ...
  override def withWorkspaceName(name: String): TransferWgsCramV1Metadata = {
    this.copy(
